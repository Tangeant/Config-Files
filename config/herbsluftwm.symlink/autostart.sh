...
# keybindings
Mod=Mod4    # Use win key as the main modifier
...
# custom commands
hc keybind $Mod-p spawn dmenu_recent
...
# resizing frames
resizestep=0.01
hc keybind Control-h		resize left +$resizestep
hc keybind Control-j		resize down +$resizestep
hc keybind Control-k		resize up +$resizestep
...
hc rule class=vivaldi-stable tag=web focus=on
